import md3_Bai9_TH1_UngDungMayTinh.CalculatorJunitTest;
...
public class TestCal {
    ...
    public void testAdd0And0(){
        ...
        int result = CalculatorJunitTest.add(first,second);
        assertEquals(expected,result);
    }
    @Test
    @DisplayName("Test add  1 + 0")
    ...
    public void testSub0And0(){
        ...
        int result = CalculatorJunitTest.sub(first,second);
        assertEquals(expected,result);
    }
    @Test
    @DisplayName("Test add  1 - 0")
